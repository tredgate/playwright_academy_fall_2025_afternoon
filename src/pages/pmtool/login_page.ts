...
export class LoginPage {
  ...
  constructor(page: Page) {
    ...
    this.loginFormBox = page.locator(".content-login");
  }
  ...
  async loginFormVisualCheck() {
    await expect(this.loginFormBox).toHaveScreenshot("login_form.png");
    return this;
  }
}
